...
def train_model(
    ...
    model.config["train"]["reduce_lr_on_plateau_monitor"] = "val_loss"
    ...
    model_checkpoint = ModelCheckpoint(
        ...
        filename="best_model-{epoch:02d}-{val_bbox_regression:.2f}",
        save_top_k=1,
        verbose=True,
    ...
    logging.info(f"Starting training for {epochs} epochs on '{accelerator}' with mixed precision...")
    trainer.fit(model)
