...
# ATENÇÃO: Verifique novamente os caminhos para a nova estrutura de pastas
# Se seus dados (imagens e CSV de anotações) também foram movidos para "C:\HololeucaGPU\", mantenha assim.
# Caso contrário, ajuste para os caminhos corretos onde eles estão.
image_dir = r"C:\HololeucaGPU\hololeuca img\semiaerea40"
annotations_csv = r"C:\HololeucaGPU\hololeuca csv beta\labels.csv"
saved_model = r"C:\HololeucaGPU\hololeuca modelo beta" # Este é o diretório de saída para o modelo treinado
...
# Se quiser logs separados para o treinamento com GPU:
# logger = TensorBoardLogger("lightning_logs_gpu")
logger = TensorBoardLogger("lightning_logs") # Mantendo o mesmo nome padrão, criará novas versões.
...
trainer = pl.Trainer(
    ...
    devices=1,         # <<< MUDANÇA: Para GPU, devices=1 para usar uma GPU (a 1050 Ti)
...
model_save_path = os.path.join(saved_model, "deepforest_hololeuca_trained_gpu.pt")


# 8. Train the model
print("Iniciando o treinamento do modelo para Cecropia Hololeuca na GPU...")
trainer.fit(model)
...
image_path_predict = r'C:\HololeucaGPU\hololeuca img\testing\teste1img\semi4.jpg'
